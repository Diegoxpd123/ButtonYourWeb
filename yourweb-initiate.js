...
(function () {
  var STYLES = [
    ...
    "  filter:",
    "    drop-shadow(0 0 calc(4px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 75%, transparent))",
    "    drop-shadow(0 0 calc(12px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 42%, transparent));",
    "  transition:filter 220ms ease-out;",
    "}",
    ":host(.shadow-on.hover-glow-on:hover) .cta-glow{",
    "  filter:",
    "    drop-shadow(0 0 calc(2px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 100%, transparent))",
    "    drop-shadow(0 0 calc(10px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 95%, transparent))",
    "    drop-shadow(0 0 calc(28px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 70%, transparent))",
    "    drop-shadow(0 0 calc(52px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 40%, transparent))",
    "    drop-shadow(0 0 calc(80px * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 18%, transparent));",
    "}",
    ".cta-glow{",
    "  display:block;",
    "  width:100%;",
    ...
    "}",
    ".cta-btn:hover .cta-shell{",
    "  padding:var(--yw-border-hover);",
    "  background:color-mix(in srgb, var(--yw-primary) 92%, white 8%);",
    "}",
    ...
    "    );",
    "  transition:box-shadow 220ms ease-out, background 220ms ease-out;",
    "}",
    ".cta-btn:hover .cta-face{",
    "  background:",
    "    radial-gradient(120% 80% at 50% 50%, color-mix(in srgb, var(--yw-primary) 14%, transparent) 0%, transparent 62%),",
    "    repeating-linear-gradient(",
    "      to bottom,",
    "      color-mix(in srgb, var(--yw-primary) 7%, transparent) 0 1px,",
    "      transparent 1px 3px",
    "    ),",
    "    linear-gradient(#050705, #000);",
    "  box-shadow:inset 0 0 28px color-mix(in srgb, var(--yw-primary) 18%, transparent);",
    "}",
    ".cta-face::before{",
    "  content:\"\";",
    "  position:absolute;",
    ...
    "  opacity:0.55;",
    "  pointer-events:none;",
    "  transition:opacity 200ms ease-out, border-color 200ms ease-out, inset 200ms ease-out;",
    "}",
    ".cta-btn:hover .cta-face::before{",
    "  opacity:0.95;",
    "  border-color:color-mix(in srgb, var(--yw-primary) 75%, transparent);",
    "  box-shadow:0 0 10px color-mix(in srgb, var(--yw-primary) 35%, transparent);",
    "}",
    ...
    "  opacity:0;",
    "  background:",
    "    linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--yw-primary) 22%, transparent) 18%, transparent 32%),",
    "    linear-gradient(90deg, transparent 68%, color-mix(in srgb, var(--yw-primary) 18%, transparent) 82%, transparent 100%);",
    "  filter:blur(6px);",
    "  transition:opacity 220ms ease-out;",
    "}",
    ".cta-btn:hover .cta-streaks{opacity:0.85;}",
    ".cta-deco{",
    "  position:absolute;",
    "  inset:0;",
    "  pointer-events:none;",
    ...
    "}",
    ".cta-btn:hover .cta-deco{opacity:1;}",
    ".cta-deco-hash{",
    "  position:absolute;",
    "  top:clamp(5px, 10cqh, 9px);",
    "  left:clamp(10px, 4cqi, 18px);",
    "  font-size:clamp(7px, 12cqh, 10px);",
    "  letter-spacing:0.08em;",
    "  line-height:1;",
    "  color:color-mix(in srgb, var(--yw-primary) 85%, transparent);",
    "  transform:skewX(-22deg);",
    "  text-shadow:0 0 8px color-mix(in srgb, var(--yw-primary) 65%, transparent);",
    "  font-family:var(--yw-font-family);",
    "}",
    ".cta-deco-bars{",
    "  position:absolute;",
    "  left:clamp(12px, 4cqi, 18px);",
    "  bottom:clamp(5px, 10cqh, 9px);",
    "  display:flex;",
    "  gap:2px;",
    "  align-items:flex-end;",
    "  height:clamp(5px, 10cqh, 8px);",
    "}",
    ".cta-deco-bars i{",
    "  display:block;",
    "  width:2px;",
    "  background:color-mix(in srgb, var(--yw-primary) 80%, transparent);",
    "  box-shadow:0 0 5px color-mix(in srgb, var(--yw-primary) 55%, transparent);",
    "}",
    ".cta-deco-bars i:nth-child(1){height:35%;}",
    ".cta-deco-bars i:nth-child(2){height:70%;}",
    ".cta-deco-bars i:nth-child(3){height:50%;}",
    ".cta-deco-bars i:nth-child(4){height:100%;}",
    ".cta-deco-bars i:nth-child(5){height:40%;}",
    ".cta-deco-bars i:nth-child(6){height:65%;}",
    ".cta-btn-inner{",
    "  position:relative;",
    "  z-index:1;",
    "  display:inline-flex;",
    ...
    "  text-shadow:",
    "    0 0 calc(0.2em * var(--yw-glow-strength)) #fff,",
    "    0 0 calc(0.55em * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 100%, transparent),",
    "    0 0 calc(1.3em * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 80%, transparent),",
    "    0 0 calc(2.4em * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 45%, transparent);",
    "}",
    ".cta-label-ghost{",
    "  position:absolute;",
    "  inset:0;",
    ...
    "  opacity:1;",
    "  border-color:color-mix(in srgb, var(--yw-primary) 90%, transparent);",
    "  box-shadow:0 0 8px color-mix(in srgb, var(--yw-primary) 55%, transparent);",
    "}",
    ".cta-icon::after{",
    "  content:\"\";",
    "  position:absolute;",
    ...
    "  width:0.28em;",
    "  height:0.28em;",
    "  background:color-mix(in srgb, var(--yw-primary) 70%, white 30%);",
    "  box-shadow:",
    "    0 0 0.4em #fff,",
    "    0 0 0.9em var(--yw-primary),",
    "    0 0 1.6em var(--yw-primary);",
    "}",
    ".cta-btn:hover .cta-icon{",
    "  box-shadow:",
    "    0 0 0.35em #fff,",
    "    0 0 0.8em color-mix(in srgb, var(--yw-primary) 100%, transparent),",
    "    0 0 1.6em color-mix(in srgb, var(--yw-primary) 70%, transparent),",
    "    0 0 2.4em color-mix(in srgb, var(--yw-primary) 40%, transparent);",
    "}",
    ".cta-scanline{",
    "  position:absolute;",
    "  left:-20%;",
    ...
    "    0 0 calc(0.85em * var(--yw-glow-strength)) color-mix(in srgb, var(--yw-primary) 35%, transparent);",
    "}",
    ".cta-btn.no-hover-glow:hover .cta-deco,",
    ".cta-btn.no-hover-glow:hover .cta-streaks{opacity:0;}",
    ".cta-btn.no-hover-glow:hover .cta-shell{padding:var(--yw-border);background:var(--yw-primary);}",
    ".cta-btn.no-hover-glow:hover .cta-face{",
    "  box-shadow:none;",
    "  background:",
    "    linear-gradient(",
    "      color-mix(in srgb, #000 calc(100% - 18% * (1 - var(--yw-bg-solidity, 1))), var(--yw-primary)),",
  ...
  class YourWebInitiate extends HTMLElement {
    ...
    constructor() {
      ...
      btn.innerHTML =
        ...
        '  <span class="cta-face">' +
        '    <span class="cta-streaks" aria-hidden="true"></span>' +
        '    <span class="cta-deco" aria-hidden="true">' +
        '      <span class="cta-deco-hash">////</span>' +
